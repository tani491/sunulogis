                          ...
                          <Button
                            ...
                            onClick={(e) => {
                              ...
                              if (establishment.phone) {
                                window.open(`https://wa.me/${establishment.phone}?text=${encodeURIComponent(`Bonjour, je suis intéressé(e) par la maison à vendre : ${establishment.name}. Est-elle toujours disponible ?`)}`, '_blank')
                              }
                            }}
                          >
